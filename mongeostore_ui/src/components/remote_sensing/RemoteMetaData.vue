 ...
 * @LastEditors: henggao
 * @LastEditTime: 2022-05-13 11:25:45
-->
<template>
  <div class="DataShow">
    <div>
      <h2
        ...
        "
      >
        <i class="el-icon-caret-right" /> 遥感影像信息
      </h2>
    </div>
    <el-container>
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  plain
                  size="mini"
                  @click="downloadfile(scope.row.remote_filename, scope.row.id)"
                  >下载文件</el-button
                >
              </template>
            </el-table-column>
      ...
      axios
        ...
        .then((response) => {
          if (response.data.size === 0) {
            ...
            link.download = remote_filename + ".tif"; // 重命名文件
            link.click();
