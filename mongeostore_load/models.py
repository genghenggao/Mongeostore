...
from mongoengine.fields import DictField, FloatField, IntField, ListField, PointField, StringField
...
connect(alias='rs_system', db='遥感数据管理子系统', host=mongos_host, port=mongos_port)
