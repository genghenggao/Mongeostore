"""
Django settings for mongeostore_v1 project.
...
SECRET_KEY = 'gw^tj=yzv$(2^hlssftjp^8ie(kp#7v36@jt6gfn!^w+t$s#n9'
...
ROOT_URLCONF = 'mongeostore_v1.urls'
...
WSGI_APPLICATION = 'mongeostore_v1.wsgi.application'
